// Generated from ../../../../Splice/Api/Token/HoldingV2/module.daml
...
export declare type Holding = damlTypes.Interface<'#splice-api-token-holding-v2:Splice.Api.Token.HoldingV2:Holding'> & HoldingView
...
export declare const Holding:
  damlTypes.InterfaceCompanion<Holding, undefined, '#splice-api-token-holding-v2:Splice.Api.Token.HoldingV2:Holding'> &
  damlTypes.FromTemplate<Holding, unknown> &
  HoldingInterface

export declare type Account = {
  owner: damlTypes.Optional<damlTypes.Party>,
