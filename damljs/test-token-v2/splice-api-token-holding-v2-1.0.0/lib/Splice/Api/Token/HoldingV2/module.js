...
exports.Holding = damlTypes.assembleInterface(
  ...
  '#4b7ecfc366d79ccc5ed07c80f26fe489cf2dfd43ce2856c06a78e6a048db7032:Splice.Api.Token.HoldingV2:Holding',
...
exports.Account = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      owner: jtv.Decoder.withDefault(null, damlTypes.Optional(damlTypes.Party).decoder),
      provider: jtv.Decoder.withDefault(null, damlTypes.Optional(damlTypes.Party).decoder),
      id: damlTypes.Text.decoder,
    });
  }),
  encode: function (__typed__) {
    return {
      owner: damlTypes.Optional(damlTypes.Party).encode(__typed__.owner),
...
exports.HoldingView = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      account: exports.Account.decoder,
  ...
  encode: function (__typed__) {
    return {
      account: exports.Account.encode(__typed__.account),
