...
exports.AllocationFactory_Allocate = {
  decoder: damlTypes.lazyMemo(function () {
    return jtv.object({
      ...
      allocation: pkg93c942ae2b4c2ba674fb152fe38473c507bda4e82b4e4c5da55a552a9d8cce1d.Splice.Api.Token.AllocationV1.AllocationSpecification.decoder,
...
exports.AllocationInstructionResult_Output = {
  ...
  AllocationInstructionResult_Completed: {
    decoder: damlTypes.lazyMemo(function () {
      return jtv.object({
        allocationCid: damlTypes.ContractId(pkg93c942ae2b4c2ba674fb152fe38473c507bda4e82b4e4c5da55a552a9d8cce1d.Splice.Api.Token.AllocationV1.Allocation).decoder,
      });
    }),
    encode: function (__typed__) {
      return {
