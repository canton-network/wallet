...
import { ListSingingProviderVaults } from './typings.js'
...
export type Methods = {
    ...
    listSingingProviderVaults: ListSingingProviderVaults
}
...
function buildController(methods: Methods) {
    return {
        ...
        listSingingProviderVaults: methods.listSingingProviderVaults,
    }
}
