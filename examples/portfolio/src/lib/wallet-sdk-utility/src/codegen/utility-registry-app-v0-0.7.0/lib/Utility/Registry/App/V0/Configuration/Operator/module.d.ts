// Generated from Utility/Registry/App/V0/Configuration/Operator.daml
...
export declare type OperatorConfiguration_Modify_Result = {
  operatorConfigurationCid: damlTypes.ContractId<OperatorConfiguration>;
};

export declare const OperatorConfiguration_Modify_Result:
  damlTypes.Serializable<OperatorConfiguration_Modify_Result> & {
  }
;
...
export declare type OperatorConfiguration_Modify = {
  newProviderRequirements: pkg5a29ead611a0abd5f5b3fc3caf7d0f67c0ff802032ab6d392824aa9060e56d70.Utility.Credential.V0.Credential.PartyCredentialRequirement[];
};

export declare const OperatorConfiguration_Modify:
  damlTypes.Serializable<OperatorConfiguration_Modify> & {
  }
;
...
export declare type OperatorConfiguration = {
  ...
  providerRequirements: pkg5a29ead611a0abd5f5b3fc3caf7d0f67c0ff802032ab6d392824aa9060e56d70.Utility.Credential.V0.Credential.PartyCredentialRequirement[];
};
...
export declare interface OperatorConfigurationInterface {
  ...
  OperatorConfiguration_Modify: damlTypes.Choice<OperatorConfiguration, OperatorConfiguration_Modify, OperatorConfiguration_Modify_Result, undefined> & damlTypes.ChoiceFrom<damlTypes.Template<OperatorConfiguration, undefined>>;
}
export declare const OperatorConfiguration:
  damlTypes.Template<OperatorConfiguration, undefined, '#utility-registry-app-v0:Utility.Registry.App.V0.Configuration.Operator:OperatorConfiguration'> &
