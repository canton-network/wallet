...
export declare type WithIssuerHolder = {
  issuer: damlTypes.Party;
  holder: damlTypes.Party;
};

export declare const WithIssuerHolder:
  damlTypes.Serializable<WithIssuerHolder> & {
  }
;


export declare type WithIssuer = {
  issuer: damlTypes.Party;
};

export declare const WithIssuer:
  damlTypes.Serializable<WithIssuer> & {
  }
;
