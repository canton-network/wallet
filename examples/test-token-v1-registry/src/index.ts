...
import adminAPIRouter from './api/admin/offerMintV2.js'
...
import { vetDamlAll } from '@canton-network/core-test-token'
 ...
 */
if (process.env.NODE_ENV === 'development') await vetDamlAll(sdk)
