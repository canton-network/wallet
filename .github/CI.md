...
| `test-unit`               | Unit/integration (Nx target `test`) | Always                                                  | `needs: build`                                                                             | `pnpm nx affected -t test --base=origin/${{ github.base_ref }} --head=HEAD --parallel`                   |
...
| `wallet-sdk-pkg`          | SDK package validation              | Always                                                  | `needs: build`                                                                             | `pnpm script:validate:package`                                                                           |
