...
interface components {
    schemas: {
        ...
        CanActAsAnyParty: { value: components['schemas']['CanActAsAnyParty1'] }
        ...
        GetCompletionByHashRequest: { transactionHash: string }
        GetCompletionByHashResponse: {
            acceptedCompletion?: components['schemas']['Completion1']
            lastRejectedCompletions?: Array<
                components['schemas']['Completion1']
            >
        }
...
export type PostV2CommandsCompletionByHash = {
    ledgerApi: {
        params: {
            resource: '/v2/commands/completion-by-hash'
            requestMethod: 'post'
            body: components['schemas']['GetCompletionByHashRequest']
            headers?: Record<string, string>
        }
        result: components['schemas']['GetCompletionByHashResponse']
    }
}
...
export type PostV2UpdatesUpdateByHash = {
    ledgerApi: {
        params: {
            resource: '/v2/updates/update-by-hash'
            requestMethod: 'post'
            body: components['schemas']['GetUpdateByHashRequest']
            headers?: Record<string, string>
        }
        result: components['schemas']['JsGetUpdateResponse']
    }
...
export type GetV2JoseJwksSynchronizerSynchronizerPartyParty = {
    ledgerApi: {
        params: {
            resource: '/v2/jose/jwks/synchronizer/{synchronizer}/party/{party}'
            requestMethod: 'get'
            path: {
                synchronizer: string
                party: string
...
export type LedgerTypes =
    ...
    | PostV2CommandsCompletionByHash
