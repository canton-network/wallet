...
export const supportedLedgerApiVersions = ['3.5'] as const
export type LedgerApiVersion = (typeof supportedLedgerApiVersions)[number]

export const supportedAsyncApiVersions = ['3.5'] as const
...
export type LedgerCommonSchemas = LedgerSchemasByVersion['3.5']

export type LedgerCommonPaths = LedgerPathsByVersion['3.5']
