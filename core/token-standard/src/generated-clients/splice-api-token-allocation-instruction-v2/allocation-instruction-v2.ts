...
export interface paths {
    '/registry/allocation-instruction/v2/allocation-factory': {
         ...
         *
         *     Registries MAY limit the size of the allocations that they support.
         *
         *     To ensure wide compatibility with apps, registries MUST support creating
         *     allocations that involve at most 25 transfer legs. In a worst case scenario
         *     this means supporting the creation of an allocation with:
         *
         *     - 25 transfer legs
    ...
    '/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept': {
        ...
        post: operations['getAllocationInstructionAcceptContext']
        delete?: never
        options?: never
        head?: never
        patch?: never
    ...
    '/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/withdraw': {
        ...
        post: operations['getAllocationInstructionWithdrawContext']
        delete?: never
        options?: never
        head?: never
        patch?: never
...
export interface operations {
    ...
    getAllocationInstructionAcceptContext: {
        parameters: {
            ...
            header?: never
            path: {
                /** @description The contract ID of the allocation instruction to accept. */
    ...
    getAllocationInstructionWithdrawContext: {
        parameters: {
            ...
            header?: never
            path: {
                /** @description The contract ID of the allocation instruction to withdraw. */
                allocationInstructionId: string
            }
            cookie?: never
        }
