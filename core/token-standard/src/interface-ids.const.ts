...
/** Special CIP-112 account ids for mint/burn destinations. */
export const CIP112_MINT_ACCOUNT_ID = 'cip-112/mint'
export const CIP112_BURN_ACCOUNT_ID = 'cip-112/burn'
