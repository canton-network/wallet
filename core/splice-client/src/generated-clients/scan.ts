...
export interface components {
    schemas: {
        ...
        GetRewardAccountingActivityTotalsResponse: components["schemas"]["RewardAccountingActivityTotalsOk"] | components["schemas"]["RewardAccountingActivityTotalsUndetermined"] | components["schemas"]["RewardAccountingActivityTotalsCannotProvide"];
        ...
        GetRewardAccountingRootHashResponse: components["schemas"]["RewardAccountingRootHashOk"] | components["schemas"]["RewardAccountingRootHashUndetermined"] | components["schemas"]["RewardAccountingRootHashCannotProvide"];
