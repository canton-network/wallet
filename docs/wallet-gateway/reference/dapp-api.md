...
> [!NOTE]
> Build dApps with the [dApp SDK](../../dapp-sdk/overview.md), which implements the
...
- [dApp SDK overview](../../dapp-sdk/overview.md)
- [dApp SDK events reference](../../dapp-sdk/reference/events.md)
