...
See [Signing providers](signing-providers.md) for each
provider's setup.
...
the schema, review the [User API](../reference/user-api.md) and
[dApp API](../reference/dapp-api.md) specifications, and check the
